    ...
    request.get(verifyURL, (err, response, body) => {
      ...
      if (body.success !== undefined && !body.success) {
        ...
        var smtpTransport = nodemailer.createTransport({
            service: 'Gmail', 
            auth: {
              user: 'shetye.vishakhatest@gmail.com',
              pass: process.env.GMAILPW1
            }
        });
         
        var mailOptions = {
            from: 'Vishakha <shetye.vishakhatest@gmail.com',
            to: 'shetye.vishakhatest@gmail.com',
            replyTo: req.body.email,
            subject: "Let's do something for society contact request from: " + req.body.name,
